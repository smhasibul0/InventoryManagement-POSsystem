                        ...
                        <div class="align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="overflow-hidden ms-4">
                                    ...
                                    <p class="my-1 text-muted fs-16">{{$profileData->role}}</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card border mb-0">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" type="text" name="phone" placeholder="Phone" aria-describedby="basic-addon1" value="{{$profileData->phone}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        <textarea class="form-control" name="address" placeholder="Add your address">{{$profileData->address}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <div class="col-lg-12 col-xl-12">
                                                        <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" class="rounded-square   avatar-xl img-thumbnail float-start" alt="image profile">
                                                    </div>
                                                </div>
